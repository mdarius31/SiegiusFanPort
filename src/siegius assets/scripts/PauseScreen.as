package
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="PauseScreen")]
               ...
               if(true)
               {
                  if(§§pop())
                  {
                     if(true)
                     {
                        ...
                        addr202:
                        if(SD.curStage < maxStage)
                        {
                           var _loc10_:*;
                           var _loc11_:* = (_loc10_ = SD).curStage + 1;
                           if(true)
                           {
                        ...
                        if(_loc1_.unlock)
                        {
                           ...
                           {
                              _loc6_ = String(_loc1_.unlock[_loc5_].substring(2));
                                 ...
                                 if("g" === _loc10_)
                                 {
                                    ...
                                    switch(true ? 0 : 3)
                                    {
                                       case 0:
                                          ...
                                          break;
                                       case 1:
                                          if((_loc7_ = GameStats.getUnitOrder(SD.race).indexOf(_loc6_) + 1) > SD.unlockUnit)
                                          {
                                          ...
                                          break;
                                       case 2:
                                          if((_loc8_ = GameStats.getSpellOrder(SD.race).indexOf(_loc6_) + 1) > SD.unlockSpell)
                                          {
         ...
         while(true)
         {
            ...
            while(true)
            {
               ...
               if(true)
               {
                  ...
                  else if("txt_sound_off" === _loc3_)
                  {
                     §§goto(addr280);
                  }
                  else if("txt_awesome_0" === _loc3_)
                  {
                     §§goto(addr285);
                  }
                  else if("txt_awesome_1" === _loc3_)
                  {
                     §§goto(addr290);
                  }
                  else if("txt_awesome_2" === _loc3_)
                  {
                     §§goto(addr295);
                  }
                  else if("txt_blood_off" === _loc3_)
                  {
                     §§goto(addr300);
                  }
                  else if("txt_blood_on" === _loc3_)
                  {
                     §§goto(addr305);
                  }
                  else if("txt_blood_lots" === _loc3_)
                  {
                     addr309:
                     §§goto(addr310);
                     §§push(15);
