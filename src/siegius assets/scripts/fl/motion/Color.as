package fl.motion
{
   ...
   public class Color extends ColorTransform
   {
      ...
      public static function interpolateColor(param1:uint, param2:uint, param3:Number) : uint
      {
         ...
         var _loc17_:uint = 0;
         _loc4_ = 1 - param3;
         _loc5_ = uint(param1 >> 24 & 255);
         _loc6_ = uint(param1 >> 16 & 255);
         _loc7_ = uint(param1 >> 8 & 255);
         _loc8_ = uint(param1 & 255);
         _loc9_ = uint(param2 >> 24 & 255);
         _loc10_ = uint(param2 >> 16 & 255);
         _loc11_ = uint(param2 >> 8 & 255);
         _loc12_ = uint(param2 & 255);
      ...
      public function setTint(param1:uint, param2:Number) : void
      {
         ...
         _loc3_ = uint(param1 >> 16 & 255);
         _loc4_ = uint(param1 >> 8 & 255);
         _loc5_ = uint(param1 & 255);
